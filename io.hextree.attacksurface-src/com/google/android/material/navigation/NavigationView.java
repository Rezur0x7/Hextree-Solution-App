...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    */
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_drawerLayoutCornerSize, 0);
        ...
        ColorStateList colorStateList = obtainTintedStyledAttributes.hasValue(R.styleable.NavigationView_subheaderColor) ? obtainTintedStyledAttributes.getColorStateList(R.styleable.NavigationView_subheaderColor) : null;
        ...
        boolean z = obtainTintedStyledAttributes.getBoolean(R.styleable.NavigationView_itemTextAppearanceActiveBoldEnabled, true);
        ...
        if (obtainTintedStyledAttributes.hasValue(R.styleable.NavigationView_itemVerticalPadding)) {
            setItemVerticalPadding(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_itemVerticalPadding, i2));
        }
        setDividerInsetStart(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_dividerInsetStart, i2));
        setDividerInsetEnd(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_dividerInsetEnd, i2));
        setSubheaderInsetStart(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_subheaderInsetStart, i2));
        setSubheaderInsetEnd(obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_subheaderInsetEnd, i2));
        ...
        int dimensionPixelSize2 = obtainTintedStyledAttributes.getDimensionPixelSize(R.styleable.NavigationView_itemIconPadding, i2);
        ...
        if (obtainTintedStyledAttributes.hasValue(R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(obtainTintedStyledAttributes.getResourceId(R.styleable.NavigationView_headerLayout, i3));
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.navigation.NavigationView$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                NavigationView.this.m107xb790515(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m107xb790515(Canvas canvas) {
