...
public class TabLayout extends HorizontalScrollView {
            ...
            if (i3 != -1) {
                ...
                try {
                    ...
                    if (colorStateList != null) {
                        this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), colorStateList.getColorForState(new int[]{16842913}, colorStateList.getDefaultColor()));
                    }
                } finally {
                }
            }
    ...
    */
    public void setScrollPosition(int i, float f, boolean z, boolean z2, boolean z3) {
        ...
        if (ViewCompat.getLayoutDirection(this) != 1 ? !z4 : !((i < getSelectedTabPosition() && calculateScrollXForTab <= scrollX) || ((i > getSelectedTabPosition() && calculateScrollXForTab >= scrollX) || i == getSelectedTabPosition()))) {
