...
public final class DurationKt {
    ...
    private static final long m1602timesmvk6XK0(int i, long j) {
        return Duration.m1514timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1601timeskIfJnKk(double d, long j) {
        return Duration.m1513timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1578getZEROUwyO8pc = Duration.Companion.m1578getZEROUwyO8pc();
        ...
        if (str2.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str2.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z7;
                        long m1512plusLRDsOJo = Duration.m1512plusLRDsOJo(m1578getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1578getZEROUwyO8pc = Duration.m1512plusLRDsOJo(m1512plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        m1578getZEROUwyO8pc = Duration.m1512plusLRDsOJo(m1578getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1578getZEROUwyO8pc = Duration.Companion.m1576getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1512plusLRDsOJo2 = Duration.m1512plusLRDsOJo(m1578getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1578getZEROUwyO8pc = Duration.m1512plusLRDsOJo(m1512plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1578getZEROUwyO8pc = Duration.m1512plusLRDsOJo(m1578getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1528unaryMinusUwyO8pc(m1578getZEROUwyO8pc) : m1578getZEROUwyO8pc;
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1476constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1476constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1476constructorimpl((j << 1) + i);
    }
