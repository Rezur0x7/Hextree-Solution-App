...
public interface TimeMark {
    ...
    TimeMark mo1466minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1468plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1613plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1612minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1468plusLRDsOJo(Duration.m1528unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1509isNegativeimpl(timeMark.mo1465elapsedNowUwyO8pc());
        }
