...
public final class LongSaturatedMathKt {
    ...
    public static final long m1604saturatingAddpTJri5U(long j, long j2) {
        long m1496getInWholeNanosecondsimpl = Duration.m1496getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1603checkInfiniteSumDefinedPjuGub4(j, j2, m1496getInWholeNanosecondsimpl);
        }
        if ((1 | (m1496getInWholeNanosecondsimpl - 1)) == Long.MAX_VALUE) {
            return m1605saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + m1496getInWholeNanosecondsimpl;
        return ((j ^ j3) & (m1496getInWholeNanosecondsimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }
    ...
    private static final long m1605saturatingAddInHalvespTJri5U(long j, long j2) {
        long m1479divUwyO8pc = Duration.m1479divUwyO8pc(j2, 2);
        if (((Duration.m1496getInWholeNanosecondsimpl(m1479divUwyO8pc) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (j + Duration.m1519toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m1604saturatingAddpTJri5U(m1604saturatingAddpTJri5U(j, m1479divUwyO8pc), Duration.m1511minusLRDsOJo(j2, m1479divUwyO8pc));
    }
