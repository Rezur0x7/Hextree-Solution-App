        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m720contentEqualskV0jMPg(((UByteArray) t).m235unboximpl(), ((UByteArray) t2).m235unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m717contentEqualsFGO6Aew(((UShortArray) t).m498unboximpl(), ((UShortArray) t2).m498unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m718contentEqualsKJPZfPQ(((UIntArray) t).m314unboximpl(), ((UIntArray) t2).m314unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m722contentEqualslec5QzE(((ULongArray) t).m393unboximpl(), ((ULongArray) t2).m393unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m734contentToString2csIQuQ(uByteArray != null ? uByteArray.m235unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m738contentToStringd6D3K8(uShortArray != null ? uShortArray.m498unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m737contentToStringXUkPCBk(uIntArray != null ? uIntArray.m314unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m740contentToStringuLth9ew(uLongArray != null ? uLongArray.m393unboximpl() : null));
            } else {
