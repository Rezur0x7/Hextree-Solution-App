...
public class Base64 {
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int i, int i2, int i3) {
        ...
        while (i2 + 2 < i3) {
            ...
            for (int i6 = 0; i6 < min; i6++) {
                int i7 = source[i2] & UByte.MAX_VALUE;
                int i8 = i2 + 2;
                int i9 = source[i2 + 1] & UByte.MAX_VALUE;
                i2 += 3;
                int i10 = (i9 << 8) | (i7 << 16) | (source[i8] & UByte.MAX_VALUE);
                destination[i5] = access$getBase64UrlEncodeMap$p[i10 >>> 18];
                destination[i5 + 1] = access$getBase64UrlEncodeMap$p[(i10 >>> 12) & 63];
                int i11 = i5 + 3;
                destination[i5 + 2] = access$getBase64UrlEncodeMap$p[(i10 >>> 6) & 63];
                i5 += 4;
                destination[i11] = access$getBase64UrlEncodeMap$p[i10 & 63];
            }
            if (min == i4 && i2 != i3) {
                int i12 = i5 + 1;
                ...
                i5 += 2;
                destination[i12] = bArr[1];
            }
        }
        int i13 = i3 - i2;
        if (i13 == 1) {
            int i14 = (source[i2] & UByte.MAX_VALUE) << 4;
            destination[i5] = access$getBase64UrlEncodeMap$p[i14 >>> 6];
            destination[i5 + 1] = access$getBase64UrlEncodeMap$p[i14 & 63];
            int i15 = i5 + 3;
            destination[i5 + 2] = padSymbol;
            i5 += 4;
            destination[i15] = padSymbol;
            i2++;
        } else if (i13 == 2) {
            int i16 = i2 + 1;
            int i17 = source[i2] & UByte.MAX_VALUE;
            i2 += 2;
            int i18 = ((source[i16] & UByte.MAX_VALUE) << 2) | (i17 << 10);
            destination[i5] = access$getBase64UrlEncodeMap$p[i18 >>> 12];
            destination[i5 + 1] = access$getBase64UrlEncodeMap$p[(i18 >>> 6) & 63];
            int i19 = i5 + 3;
            destination[i5 + 2] = access$getBase64UrlEncodeMap$p[i18 & 63];
            i5 += 4;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00dd, code lost:
        r1 = r19[r0] & kotlin.UByte.MAX_VALUE;
    ...
    */
    private final int decodeImpl(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (true) {
            ...
            if (i6 == i4 && i8 + 3 < i3) {
                int i9 = i8 + 4;
                int i10 = (access$getBase64UrlDecodeMap$p[bArr[i8] & UByte.MAX_VALUE] << 18) | (access$getBase64UrlDecodeMap$p[bArr[i8 + 1] & UByte.MAX_VALUE] << 12) | (access$getBase64UrlDecodeMap$p[bArr[i8 + 2] & UByte.MAX_VALUE] << 6) | access$getBase64UrlDecodeMap$p[bArr[i8 + 3] & UByte.MAX_VALUE];
                if (i10 >= 0) {
            ...
            if (i13 >= 0) {
                ...
                String num = Integer.toString(i12, CharsKt.checkRadix(8));
