...
public class TransitionSet extends Transition {
    ...
    */
    public void setCurrentPlayTimeMillis(long j, long j2) {
        ...
        if (this.mPlayTogether) {
            ...
            if (this.mParent == null) {
                ...
                if ((i4 <= 0 || j2 > totalDurationMillis) && (i2 >= 0 || j2 < 0)) {
                    return;
                }
                if (i4 > 0) {
                    this.mEnded = true;
    ...
    public Transition clone() {
        TransitionSet transitionSet = (TransitionSet) super.m51clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).m51clone());
        }
