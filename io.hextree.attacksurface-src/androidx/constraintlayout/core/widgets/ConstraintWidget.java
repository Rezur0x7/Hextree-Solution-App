...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:272:0x04de A[ADDED_TO_REGION] */
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (constraintWidget4 != null) {
            boolean z17 = constraintWidget4 != null && constraintWidget4.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            ConstraintWidget constraintWidget5 = this.mParent;
            boolean z18 = constraintWidget5 != null && constraintWidget5.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
                ...
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i5 == 3 && i6 == 3) {
                    ...
                    if (this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT) {
                        ...
                        if (z7) {
                            ...
                            if (i20 == 0 || i20 == -1) {
                                z8 = true;
                                boolean z21 = !z7 && ((i17 = this.mResolvedDimensionRatioSide) == 1 || i17 == i11);
                                    ...
                                    if (z || (horizontalWidgetRun = this.horizontalRun) == null || !horizontalWidgetRun.start.resolved || !this.horizontalRun.end.resolved) {
                                        ...
                                        if (z) {
                                            ...
                                            if (verticalWidgetRun != null && verticalWidgetRun.start.resolved && constraintWidget3.verticalRun.end.resolved) {
                                                ...
                                                i16 = i14;
                                                if (constraintWidget3.mVerticalResolution == 2 || i16 == 0 || constraintWidget3.resolvedVertical) {
                                                    solverVariable9 = solverVariable7;
                                                    solverVariable10 = solverVariable8;
                                                } else {
                                                    z15 = (constraintWidget3.mListDimensionBehaviors[i15] == DimensionBehaviour.WRAP_CONTENT || !(constraintWidget3 instanceof ConstraintWidgetContainer)) ? i14 : i15;
                                                    if (z15) {
                                                        i7 = i14;
                                                    }
                                                    ...
                                                    if (constraintWidget3.mBaselineDistance <= 0 || constraintWidget3.mVisibility == i13) {
                                                        if (constraintWidget3.mBaseline.mTarget == null) {
                                                            ...
                                                            solverVariable9 = solverVariable7;
                                                            solverVariable10 = solverVariable8;
                                                            applyConstraints(linearSystem, false, z13, z12, z24, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr2[i15], z15, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i7, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[i15], constraintWidget3.mVerticalBiasPercent, z21, dimensionBehaviourArr2[0] != DimensionBehaviour.MATCH_CONSTRAINT, z5, z6, z22, i8, i9, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z16);
                                                    ...
                                                    solverVariable9 = solverVariable7;
                                                    solverVariable10 = solverVariable8;
                                                    applyConstraints(linearSystem, false, z13, z12, z242, createObjectVariable9, createObjectVariable8, dimensionBehaviourArr22[i15], z15, constraintWidget3.mTop, constraintWidget3.mBottom, constraintWidget3.mY, i7, constraintWidget3.mMinHeight, constraintWidget3.mMaxDimension[i15], constraintWidget3.mVerticalBiasPercent, z21, dimensionBehaviourArr22[0] != DimensionBehaviour.MATCH_CONSTRAINT, z5, z6, z22, i8, i9, constraintWidget3.mMatchConstraintMinHeight, constraintWidget3.mMatchConstraintMaxHeight, constraintWidget3.mMatchConstraintPercentHeight, z16);
                                                }
                                                if (z14) {
                                        ...
                                        if (constraintWidget3.mVerticalResolution == 2) {
                                            if (constraintWidget3.mListDimensionBehaviors[i15] == DimensionBehaviour.WRAP_CONTENT) {
                                            }
                                            if (z15) {
                                            }
                                            ConstraintWidget constraintWidget92 = constraintWidget3.mParent;
                                            if (constraintWidget92 == null) {
                                            }
                                            ConstraintWidget constraintWidget102 = constraintWidget3.mParent;
            ...
            if (i9 != 4) {
                            ...
                            if (z13) {
                                if (i9 == 0) {
                                    ...
                                    if ((constraintWidget6 instanceof Barrier) || (constraintWidget7 instanceof Barrier)) {
                                        ...
                                        if (z16) {
                                            ...
                                            solverVariable13 = solverVariable5;
                                            solverVariable14 = createObjectVariable3;
                                            linearSystem.addCentering(createObjectVariable3, solverVariable4, constraintAnchor.getMargin(), f, solverVariable6, solverVariable17, constraintAnchor2.getMargin(), i26);
                                            i19 = i27;
                                            z18 = z20;
                                        }
                                        ...
                                        if (z19 || !z10 || (constraintWidget6 instanceof Barrier) || (constraintWidget2 instanceof Barrier)) {
                                            ...
                                            if (constraintWidget2 != constraintWidget3) {
                                                ...
                                                if (z18) {
                                                    if (z17 && (!z9 || z3)) {
                                                        int i37 = (constraintWidget6 == constraintWidget3 || constraintWidget2 == constraintWidget3) ? 6 : i23;
                                                        i37 = ((constraintWidget6 instanceof Guideline) || (constraintWidget2 instanceof Guideline)) ? 5 : 5;
                                                        i37 = ((constraintWidget6 instanceof Barrier) || (constraintWidget2 instanceof Barrier)) ? 5 : 5;
                                                        if (z9) {
                                                            i37 = 5;
                                                        }
                                                        i23 = Math.max(i37, i23);
                                                    }
                                                    if (z19) {
                                                        i23 = (z6 && !z9 && (constraintWidget6 == constraintWidget3 || constraintWidget2 == constraintWidget3)) ? 4 : Math.min(i19, i23);
                                                    }
                                                    linearSystem.addEquality(solverVariable14, solverVariable4, constraintAnchor.getMargin(), i23);
                                                    linearSystem.addEquality(solverVariable15, solverVariable6, -constraintAnchor2.getMargin(), i23);
                                                }
                                                if (z19) {
                                ...
                                if (z2 && z14) {
                                    ...
                                    if (solverVariable6 != solverVariable11) {
                                        linearSystem.addGreaterThan(solverVariable11, solverVariable5, i18, 5);
                                        return;
                                    }
                                    return;
                                }
                ...
                if (i16 >= i17 && z2 && z14) {
                    ...
                    if (!z && this.mBaseline.mTarget != null) {
                        ...
                        if (constraintWidget8.mDimensionRatio == 0.0f || constraintWidget8.mListDimensionBehaviors[i15] != DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget8.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT) {
                            return;
                        }
                    } else if (i38 == 0) {
                        return;
