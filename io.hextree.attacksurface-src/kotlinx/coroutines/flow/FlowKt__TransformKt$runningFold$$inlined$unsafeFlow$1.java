        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Object emit = flowCollector.emit(t, anonymousClass1);
                ...
                if (this.$this_runningFold$inlined.collect(new FlowKt__TransformKt$runningFold$1$1(objectRef, this.$operation$inlined, flowCollector2), anonymousClass1) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            }
