...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m150constructorimpl = Result.m150constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m150constructorimpl = Result.m150constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m156isFailureimpl(m150constructorimpl) ? null : m150constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1676installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1676installSignalHandler$lambda1(Signal signal) {
