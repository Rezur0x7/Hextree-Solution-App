...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1637delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1638toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1638toDelayMillisLRDsOJo(long j) {
        if (Duration.m1475compareToLRDsOJo(j, Duration.Companion.m1578getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1494getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
