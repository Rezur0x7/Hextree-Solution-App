    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m150constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m150constructorimpl2 = Result.m150constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m150constructorimpl2 = Result.m150constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m153exceptionOrNullimpl(m150constructorimpl2));
        } catch (Throwable th2) {
            try {
            ...
            handleFatalException(th2, Result.m153exceptionOrNullimpl(m150constructorimpl));
        }
    }
