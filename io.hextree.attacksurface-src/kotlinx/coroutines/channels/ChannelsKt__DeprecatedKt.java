                    ...
                    try {
                        if (i == 1) {
                            ...
                            if (next != null) {
                                ...
                                if (sendChannel2.send(next, channelsKt__DeprecatedKt$filterNotNullTo$33) == coroutine_suspended) {
                                    return coroutine_suspended;
                                }
                            }
                            channelIterator2 = channelIterator;
