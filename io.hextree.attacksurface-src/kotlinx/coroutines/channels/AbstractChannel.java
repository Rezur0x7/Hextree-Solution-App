...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1651receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        return pollInternal instanceof Closed ? ChannelResult.Companion.m1671closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1673successJP2dKIU(pollInternal);
                    }
                ...
                return ((ChannelResult) obj).m1670unboximpl();
            }
        }
        ...
        return ((ChannelResult) obj2).m1670unboximpl();
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object mo1652tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1672failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1671closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1673successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        Object m1691constructorimpl$default = InlineList.m1691constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.remove()) {
                    ...
                    m1691constructorimpl$default = InlineList.m1696plusFjFbRPM(m1691constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1650onCancelIdempotentListww6eGU(m1691constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i == 1) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1658boximpl(z ? ChannelResult.Companion.m1671closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m1673successJP2dKIU(obj)), selectInstance.getCompletion());
            } else {
            ...
            if (i == 1 && selectInstance.trySelect()) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1658boximpl(ChannelResult.Companion.m1671closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m150constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m150constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1658boximpl(ChannelResult.Companion.m1673successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m150constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            ChannelResult m1658boximpl = ChannelResult.m1658boximpl(ChannelResult.Companion.m1671closedJP2dKIU(closed.closeCause));
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m150constructorimpl(m1658boximpl));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1658boximpl(ChannelResult.Companion.m1673successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1658boximpl(ChannelResult.Companion.m1671closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1650onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj == null) {
            return;
        }
