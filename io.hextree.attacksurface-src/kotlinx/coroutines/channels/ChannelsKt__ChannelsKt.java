...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        if (!(mo1653trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1653trySendJP2dKIU;
            return ChannelResult.Companion.m1673successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m1670unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1668isSuccessimpl(sendChannel.mo1653trySendJP2dKIU(e))) {
            return;
        }
