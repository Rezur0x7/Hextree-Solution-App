...
public interface ReceiveChannel<E> {
    ...
    Object mo1651receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1652tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1652tryReceivePtdJZtk = receiveChannel.mo1652tryReceivePtdJZtk();
            if (ChannelResult.m1668isSuccessimpl(mo1652tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1664getOrThrowimpl(mo1652tryReceivePtdJZtk);
            }
            Throwable m1662exceptionOrNullimpl = ChannelResult.m1662exceptionOrNullimpl(mo1652tryReceivePtdJZtk);
            if (m1662exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1662exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1651receiveCatchingJP2dKIU = receiveChannel.mo1651receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m1663getOrNullimpl(mo1651receiveCatchingJP2dKIU);
                }
            }
