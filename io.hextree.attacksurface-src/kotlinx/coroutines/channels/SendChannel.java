...
public interface SendChannel<E> {
    ...
    Object mo1653trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1653trySendJP2dKIU = sendChannel.mo1653trySendJP2dKIU(e);
            if (ChannelResult.m1668isSuccessimpl(mo1653trySendJP2dKIU)) {
                return true;
            }
            Throwable m1662exceptionOrNullimpl = ChannelResult.m1662exceptionOrNullimpl(mo1653trySendJP2dKIU);
