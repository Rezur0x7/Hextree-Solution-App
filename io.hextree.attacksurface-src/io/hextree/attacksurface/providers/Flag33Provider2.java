...
public class Flag33Provider2 extends ContentProvider {
    public static final String AUTHORITY = "io.hextree.flag33_2";
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        StringBuilder append = new StringBuilder("Flag33Provider2.query('").append(uri.getPath()).append("'): ");
        UriMatcher uriMatcher2 = uriMatcher;
        Log.i("Flag33Provider2", append.append(uriMatcher2.match(uri)).toString());
    ...
    void prepareDB(LogHelper logHelper) {
        ...
        contentValues.put(FlagDatabaseHelper.COLUMN_CONTENT, logHelper.appendLog(Flag33Activity2.FLAG));
    ...
    public void success(LogHelper logHelper) {
        try {
            ...
            intent.setClass(getContext(), Flag33Activity2.class);
            ...
            e.printStackTrace();
            Log.e("Flag33Provider2", "Exception in start activity. Restart the target app and try again.", e);
        }
    }
