...
public class SolvedPreferences {
    private static final String PREFS_NAME = "HextreePreferences";
    ...
    public static int countSolved() {
        ...
        for (Map.Entry<String, ?> entry : sharedPreferences2.getAll().entrySet()) {
            ...
            if (entry.getKey().contains(":solved") && (value instanceof Boolean) && ((Boolean) value).booleanValue()) {
                i++;
            }
        }
        return i;
